...
set ::global_corename ftile_xcvr_test_directphy_f_0_directphy_f_490_kb6ooeq
# -------------------------------- #
# --- Default Profile settings --- #
# -------------------------------- #
dict set phy_ip_params xcvr_type_profile0 "FGT"
dict set phy_ip_params num_sys_cop_profile0 "1"
dict set phy_ip_params pma_data_rate_profile0 "25000"
...
dict set phy_ip_params pma_outclk_freq_mhz_profile0 "781.25"
dict set phy_ip_params syspll_outclk_freq_mhz_profile0 "781.25"
...
dict set phy_ip_params pldif_rx_clkout_freq_mhz_profile0 "390.625"
dict set phy_ip_params pldif_rx_clkout2_freq_mhz_profile0 "Disabled"
dict set phy_ip_params pldif_tx_clkout_freq_mhz_profile0 "390.625"
