	ftile_xcvr_test_xcvr_st_converter_0 u0 (
		.tx_parallel_data   (_connected_to_tx_parallel_data_),   //  output,  width = 80,   tx_parallel_data.tx_parallel_data
		.tx_clkout          (_connected_to_tx_clkout_),          //   input,   width = 1,          tx_clkout.clk
		.rx_parallel_data   (_connected_to_rx_parallel_data_),   //   input,  width = 80,   rx_parallel_data.rx_parallel_data
		...
		.tx_clkout_sample   (_connected_to_tx_clkout_sample_),   //  output,   width = 1,   tx_clkout_sample.clk
