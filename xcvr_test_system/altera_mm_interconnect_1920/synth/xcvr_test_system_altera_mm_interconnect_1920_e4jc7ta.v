// xcvr_test_system_altera_mm_interconnect_1920_e4jc7ta.v
...
`timescale 1 ps / 1 ps
module xcvr_test_system_altera_mm_interconnect_1920_e4jc7ta (
	...
	wire  [110:0] data_pattern_checker_0_csr_slave_agent_rf_source_data;               // data_pattern_checker_0_csr_slave_agent:rf_source_data -> data_pattern_checker_0_csr_slave_agent_rsp_fifo:in_data
	...
	wire  [110:0] data_pattern_checker_0_csr_slave_agent_rsp_fifo_out_data;            // data_pattern_checker_0_csr_slave_agent_rsp_fifo:out_data -> data_pattern_checker_0_csr_slave_agent:rf_sink_data
	...
	wire          cmd_mux_src_valid;                                                   // cmd_mux:src_valid -> data_pattern_checker_0_csr_slave_agent:cp_valid
	wire  [109:0] cmd_mux_src_data;                                                    // cmd_mux:src_data -> data_pattern_checker_0_csr_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                   // data_pattern_checker_0_csr_slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                 // cmd_mux:src_channel -> data_pattern_checker_0_csr_slave_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                           // cmd_mux:src_startofpacket -> data_pattern_checker_0_csr_slave_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                             // cmd_mux:src_endofpacket -> data_pattern_checker_0_csr_slave_agent:cp_endofpacket
	...
	wire  [110:0] data_pattern_generator_0_csr_slave_agent_rf_source_data;             // data_pattern_generator_0_csr_slave_agent:rf_source_data -> data_pattern_generator_0_csr_slave_agent_rsp_fifo:in_data
	...
	wire  [110:0] data_pattern_generator_0_csr_slave_agent_rsp_fifo_out_data;          // data_pattern_generator_0_csr_slave_agent_rsp_fifo:out_data -> data_pattern_generator_0_csr_slave_agent:rf_sink_data
	...
	wire          cmd_mux_001_src_valid;                                               // cmd_mux_001:src_valid -> data_pattern_generator_0_csr_slave_agent:cp_valid
	wire  [109:0] cmd_mux_001_src_data;                                                // cmd_mux_001:src_data -> data_pattern_generator_0_csr_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                               // data_pattern_generator_0_csr_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                             // cmd_mux_001:src_channel -> data_pattern_generator_0_csr_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                       // cmd_mux_001:src_startofpacket -> data_pattern_generator_0_csr_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                         // cmd_mux_001:src_endofpacket -> data_pattern_generator_0_csr_slave_agent:cp_endofpacket
	...
	wire          data_pattern_checker_0_csr_slave_agent_rp_valid;                     // data_pattern_checker_0_csr_slave_agent:rp_valid -> router_001:sink_valid
	wire  [109:0] data_pattern_checker_0_csr_slave_agent_rp_data;                      // data_pattern_checker_0_csr_slave_agent:rp_data -> router_001:sink_data
	wire          data_pattern_checker_0_csr_slave_agent_rp_ready;                     // router_001:sink_ready -> data_pattern_checker_0_csr_slave_agent:rp_ready
	wire          data_pattern_checker_0_csr_slave_agent_rp_startofpacket;             // data_pattern_checker_0_csr_slave_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          data_pattern_checker_0_csr_slave_agent_rp_endofpacket;               // data_pattern_checker_0_csr_slave_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire          data_pattern_generator_0_csr_slave_agent_rp_valid;                   // data_pattern_generator_0_csr_slave_agent:rp_valid -> router_002:sink_valid
	wire  [109:0] data_pattern_generator_0_csr_slave_agent_rp_data;                    // data_pattern_generator_0_csr_slave_agent:rp_data -> router_002:sink_data
	wire          data_pattern_generator_0_csr_slave_agent_rp_ready;                   // router_002:sink_ready -> data_pattern_generator_0_csr_slave_agent:rp_ready
	wire          data_pattern_generator_0_csr_slave_agent_rp_startofpacket;           // data_pattern_generator_0_csr_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          data_pattern_generator_0_csr_slave_agent_rp_endofpacket;             // data_pattern_generator_0_csr_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	xcvr_test_system_altera_merlin_master_translator_192_54w642y #(
		.AV_ADDRESS_W                (13),
		.AV_DATA_W                   (32),
		.AV_BURSTCOUNT_W             (1),
		.AV_BYTEENABLE_W             (4),
	...
	xcvr_test_system_altera_merlin_slave_translator_191_xg7rzxi #(
		.AV_ADDRESS_W                   (3),
		.AV_DATA_W                      (32),
		.UAV_DATA_W                     (32),
		.AV_BURSTCOUNT_W                (1),
	...
	xcvr_test_system_altera_merlin_master_agent_1930_l64uqry #(
		.PKT_WUNIQUE               (91),
		.PKT_DOMAIN_H              (90),
		.PKT_DOMAIN_L              (89),
		.PKT_SNOOP_H               (88),
		...
		.cp_data               (mm_bridge_0_m0_agent_cp_data),                                      //  output,  width = 110,          .data
		...
		.rp_data               (mm_bridge_0_m0_limiter_rsp_src_data),                               //   input,  width = 110,          .data
	...
	xcvr_test_system_altera_merlin_slave_agent_1930_jxauz3i #(
		.PKT_ORI_BURST_SIZE_H      (82),
		.PKT_ORI_BURST_SIZE_L      (80),
		.PKT_RESPONSE_STATUS_H     (79),
		.PKT_RESPONSE_STATUS_L     (78),
		...
		.rp_data                 (data_pattern_checker_0_csr_slave_agent_rp_data),                    //  output,  width = 110,                .data
		...
		.rf_sink_data            (data_pattern_checker_0_csr_slave_agent_rsp_fifo_out_data),          //   input,  width = 111,                .data
		...
		.rf_source_data          (data_pattern_checker_0_csr_slave_agent_rf_source_data),             //  output,  width = 111,                .data
	...
	xcvr_test_system_altera_avalon_sc_fifo_1932_22gxxgi #(
		.SYMBOLS_PER_BEAT    (1),
		.BITS_PER_SYMBOL     (111),
		.FIFO_DEPTH          (2),
		.CHANNEL_WIDTH       (0),
		...
		.in_data           (data_pattern_checker_0_csr_slave_agent_rf_source_data),             //   input,  width = 111,        in.data
		...
		.out_data          (data_pattern_checker_0_csr_slave_agent_rsp_fifo_out_data),          //  output,  width = 111,       out.data
	...
	xcvr_test_system_altera_merlin_slave_agent_1930_jxauz3i #(
		...
		.rp_data                 (data_pattern_generator_0_csr_slave_agent_rp_data),                    //  output,  width = 110,                .data
		...
		.rf_sink_data            (data_pattern_generator_0_csr_slave_agent_rsp_fifo_out_data),          //   input,  width = 111,                .data
		...
		.rf_source_data          (data_pattern_generator_0_csr_slave_agent_rf_source_data),             //  output,  width = 111,                .data
	...
	xcvr_test_system_altera_avalon_sc_fifo_1932_22gxxgi #(
		...
		.clk               (clk_50_clk_clk),                                                      //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset),                       //   input,    width = 1, clk_reset.reset
		.in_data           (data_pattern_generator_0_csr_slave_agent_rf_source_data),             //   input,  width = 111,        in.data
		...
		.out_data          (data_pattern_generator_0_csr_slave_agent_rsp_fifo_out_data),          //  output,  width = 111,       out.data
	...
	xcvr_test_system_altera_merlin_router_1921_ls63sqa router (
		...
		.sink_data          (mm_bridge_0_m0_agent_cp_data),                                //   input,  width = 110,          .data
	...
	xcvr_test_system_altera_merlin_router_1921_jfbwtoy router_001 (
		.sink_ready         (data_pattern_checker_0_csr_slave_agent_rp_ready),             //  output,    width = 1,      sink.ready
		.sink_valid         (data_pattern_checker_0_csr_slave_agent_rp_valid),             //   input,    width = 1,          .valid
		.sink_data          (data_pattern_checker_0_csr_slave_agent_rp_data),              //   input,  width = 110,          .data
		.sink_startofpacket (data_pattern_checker_0_csr_slave_agent_rp_startofpacket),     //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (data_pattern_checker_0_csr_slave_agent_rp_endofpacket),       //   input,    width = 1,          .endofpacket
		.clk                (clk_50_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	xcvr_test_system_altera_merlin_router_1921_jfbwtoy router_002 (
		.sink_ready         (data_pattern_generator_0_csr_slave_agent_rp_ready),           //  output,    width = 1,      sink.ready
		.sink_valid         (data_pattern_generator_0_csr_slave_agent_rp_valid),           //   input,    width = 1,          .valid
		.sink_data          (data_pattern_generator_0_csr_slave_agent_rp_data),            //   input,  width = 110,          .data
		.sink_startofpacket (data_pattern_generator_0_csr_slave_agent_rp_startofpacket),   //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (data_pattern_generator_0_csr_slave_agent_rp_endofpacket),     //   input,    width = 1,          .endofpacket
		.clk                (clk_50_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	xcvr_test_system_altera_merlin_traffic_limiter_1921_p3fvlba #(
		.SYNC_RESET                           (1),
		.PKT_DEST_ID_H                        (69),
		.PKT_DEST_ID_L                        (69),
		.PKT_SRC_ID_H                         (68),
		...
		.cmd_src_data           (mm_bridge_0_m0_limiter_cmd_src_data),                         //  output,  width = 110,          .data
		...
		.rsp_src_data           (mm_bridge_0_m0_limiter_rsp_src_data),                         //  output,  width = 110,          .data
	...
	xcvr_test_system_altera_merlin_demultiplexer_1921_4lcugii cmd_demux (
		.clk                (clk_50_clk_clk),                                              //   input,    width = 1,        clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (mm_bridge_0_m0_limiter_cmd_src_data),                         //   input,  width = 110,           .data
	...
	xcvr_test_system_altera_merlin_multiplexer_1922_mkcgjai cmd_mux (
		.clk                 (clk_50_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	xcvr_test_system_altera_merlin_multiplexer_1922_mkcgjai cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	xcvr_test_system_altera_merlin_demultiplexer_1921_d7jptfy rsp_demux (
		.clk                (clk_50_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	xcvr_test_system_altera_merlin_demultiplexer_1921_d7jptfy rsp_demux_001 (
		.clk                (clk_50_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	xcvr_test_system_altera_merlin_multiplexer_1922_fzxajyi rsp_mux (
		.clk                 (clk_50_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
