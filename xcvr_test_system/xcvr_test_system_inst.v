	xcvr_test_system u0 (
		...
		.data_pattern_checker_0_conduit_pattern_in_clk_export    (_connected_to_data_pattern_checker_0_conduit_pattern_in_clk_export_),    //   input,   width = 1,    data_pattern_checker_0_conduit_pattern_in_clk.export
		.data_pattern_checker_0_conduit_pattern_in_export        (_connected_to_data_pattern_checker_0_conduit_pattern_in_export_),        //   input,  width = 64,        data_pattern_checker_0_conduit_pattern_in.export
		.data_pattern_generator_0_conduit_pattern_out_clk_export (_connected_to_data_pattern_generator_0_conduit_pattern_out_clk_export_), //   input,   width = 1, data_pattern_generator_0_conduit_pattern_out_clk.export
		.data_pattern_generator_0_conduit_pattern_out_export     (_connected_to_data_pattern_generator_0_conduit_pattern_out_export_),     //  output,  width = 64,     data_pattern_generator_0_conduit_pattern_out.export
		...
		.mm_bridge_0_s0_address                                  (_connected_to_mm_bridge_0_s0_address_),                                  //   input,  width = 13,                                                 .address
